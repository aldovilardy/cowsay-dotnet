...
/// <summary>
/// Cmdlet to generate a Cowsay message.
/// </summary>
[Cmdlet(VerbsCommon.Get, "Cowsay")]
public class GetCowsayCommand : PSCmdlet
{
    /// <summary>
    ...
    /// <summary>
    /// Processes the current record by generating and writing a cowsay ASCII-art string to the pipeline.
    /// </summary>
    /// <remarks>
